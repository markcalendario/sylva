...
export const THEMES: readonly Theme[] = ["forest", "professional"];
...
export const THEME_TIP: Record<Theme, string> = {
  ...
  professional: "Black and white, Inter, no forest — for a screen others can see",
};
 ...
 * a stylesheet that fails to load leaves the app in the theme it was designed
 * in rather than in a half-applied other one.
 */
